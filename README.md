...
2. [go to](https://www.youtube.com/watch?v=_kkM802vgbI)

3. laravel, URL generate korar jonno URL helper function provide kore. laravel jokhon ekta url generate kore tokhon autometically scheme(http/https) use kore.
...
5. What is the purpes of exception?
